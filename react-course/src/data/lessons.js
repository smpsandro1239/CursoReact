...
- [ ] Sei criar strings dinâmicas com template literals.`,
  ...
  },
  {
    ...
    proTip: "Evita o 'aninhamento excessivo' (muitos if dentro de if) usando return cedo ou guard clauses. Código limpo é código legível!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo a importância dos operadores lógicos (\`&&\`, \`||\`).`,
    practice: "Cria um programa que verifica a força de uma password. Ela deve ter pelo menos 8 caracteres. Usa um loop para contar se tem números e condicionais para classificar como 'Fraca' ou 'Forte'.",
    resources: [
...
- [ ] Sei como extrair um resultado usando \`return\`.`,
    practice: "Cria uma calculadora modular. Define 4 funções (somar, subtrair, multiplicar, dividir) e uma função principal 'calcular(op, a, b)' que decide qual usar. Inclui uma verificação para não permitir divisão por zero!",
    resources: [
...
- [ ] Entendo porque devo criar cópias em vez de mudar o original.`,
    practice: "Cria um array de objetos chamado 'produtos', onde cada um tem nome e preco. Usa o .filter() para listar apenas os produtos com preço superior a 50€ e o .map() para criar uma nova lista apenas com os nomes desses produtos.",
    resources: [
...
- [ ] Sei criar um elemento novo e colocá-lo na página.`,
    practice: "Cria um pequeno contador HTML com um <span> para o número e dois botões (+ e -). Usa JavaScript para atualizar o número no ecrã sempre que um botão for clicado.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Nunca esqueças de fechar tags em JSX! Mesmo tags como <img> devem ser escritas como <img /> (self-closing).",
    content: `### O que vais aprender nesta aula:
...
- [ ] Estou pronto para passar dados entre componentes.`,
    practice: "Cria um componente chamado 'CartaoPerfil' que exiba um título, uma descrição e um botão. Usa JSX e garante que todas as tags estão corretamente fechadas.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Tenta desestruturar as tuas props logo nos parâmetros da função: function Utilizador({ nome }) { ... }. Fica muito mais limpo!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo que as props não podem ser alteradas pelo Filho.`,
    practice: "Cria um componente 'CartaoProduto' que recebe 'nome', 'preco' e 'categoria' como props. Depois, no App.jsx, renderiza três cartões com produtos diferentes.",
    resources: [
...
- [ ] Entendo que nunca devo fazer \`estado = novoValor\` diretamente.`,
    practice: "Cria um componente 'Alternador' com um botão que diz 'LIGADO' ou 'DESLIGADO'. Usa um estado booleano para alternar o texto e a cor do botão a cada clique.",
    resources: [
...
- [ ] Consigo reagir a mudanças de variáveis específicas.`,
    practice: "Cria um componente que exibe o tamanho da janela (largura) em tempo real. Usa useEffect para adicionar um Event Listener de 'resize' e não te esqueças de o remover na função de limpeza.",
    resources: [
...
- [ ] Percebo que hooks personalizados podem chamar outros hooks.`,
    practice: "Cria um hook personalizado chamado 'useCounter' que aceite um valor máximo e forneça funções para incrementar, decrementar e repor o valor.",
    resources: [
...
- [ ] Entendo como capturar parâmetros da URL com \`useParams\`.`,
    practice: "Cria um sistema de mini-blog com duas páginas: uma Lista de Posts e uma Página de Detalhe. A página de detalhe deve exibir o ID do post capturado da URL.",
    resources: [
...
- [ ] Sei como envolver a app com múltiplos Providers.`,
    practice: "Cria um Contexto de Autenticação (AuthContext) que guarda o nome do utilizador. Exibe o nome do utilizador na Barra de Navegação e na Página de Perfil sem passar props entre elas.",
    resources: [
...
- [ ] Sei que a otimização prematura deve ser evitada.`,
    practice: "Cria uma lista de 500 números aleatórios e um botão para os ordenar. Usa o useMemo para garantir que a ordenação (cálculo caro) só acontece quando a lista realmente muda, e não em cada clique noutros botões da página.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Nunca testes a implementação interna (como o estado). Testa o que o utilizador vê e faz. Isto torna os teus testes resilientes a mudanças no código.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Entendo que os testes devem focar-se no comportamento, não no código interno.`,
    practice: "Escreve testes para um componente de formulário de login simples. Verifica se os campos de email e password existem e se o botão de login está presente no ecrã.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Não tentes tipar tudo perfeitamente à primeira. Começa com as props dos novos componentes e vai avançando gradualmente. O 'any' deve ser o teu último recurso!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo como o TS me ajuda a evitar erros de "null".`,
    practice: "Converte um componente simples de 'Lista de Tarefas' para TypeScript. Define uma interface 'Tarefa' com 'id', 'texto' e 'concluida' e garante que a array no useState segue esse tipo.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Pensa nos teus componentes como unidades completas: lógica + design no mesmo ficheiro. Isto evita estilos 'órfãos' que ninguém sabe onde estão.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo as vantagens de não usar ficheiros .css externos.`,
    practice: "Cria um componente 'Card' estilizado que mude a cor da borda dependendo de uma prop 'status' (ex: 'sucesso' -> verde, 'erro' -> vermelho).",
    resources: [
  ...
  },
  {
    ...
    proTip: "Nunca uses useEffect para buscar dados se puderes usar React Query! Ele resolve problemas de cache e estados de erro que demorarias semanas a implementar sozinho.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Entendo como atualizar a cache após uma mutação.`,
    practice: "Implementa uma lista de 'Posts' usando o useQuery. Adiciona um botão que, ao ser clicado, força a atualização dos dados (refetch).",
    resources: [
  ...
  },
  {
    ...
    proTip: "Usa a abordagem 'uncontrolled' do React Hook Form para evitar re-renderizações desnecessárias em cada tecla que o utilizador prime. A tua app vai voar!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Entendo a vantagem de performance sobre os formulários "controlados" tradicionais.`,
    practice: "Cria um formulário de 'Registo de Utilizador' com campos para Nome, Email e Password. O campo Password deve ter um tamanho mínimo de 8 caracteres e o Email deve ser obrigatório.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Nunca confies apenas no frontend. A segurança real é feita no servidor; o frontend apenas esconde o que o utilizador não deve ver. Mantém sempre o teu backend seguro!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Sei como limpar os dados no Logout.`,
    practice: "Implementa um sistema onde a página '/dashboard' só é visível se o utilizador estiver 'autenticado' no teu Contexto. Se não estiver, redireciona-o para a página de '/login'.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Escreve testes como se estivesses a documentar o comportamento da app. Um bom teste deve ser legível por qualquer colega de equipa.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Sei simular um erro de servidor num teste.`,
    practice: "Escreve um teste para o hook 'useCounter' (da aula 11). Garante que ele começa em 0, que incrementa corretamente e que não ultrapassa o valor máximo definido.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Usa o React DevTools Profiler para identificar exatamente qual o componente que está a travar a tua aplicação. Medir antes de otimizar é a chave!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo porque é que o bundle final deve ser pequeno.`,
    practice: "Transforma as rotas do teu projeto principal em rotas 'lazy'. Adiciona um componente de 'Spinner' ou uma mensagem de carregamento dentro do Suspense.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Pensa como um atacante: 'Como é que eu poderia abusar deste formulário?'. Sanitizar todos os inputs do utilizador não é opcional, é obrigatório.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo que o frontend nunca deve ter segredos críticos.`,
    practice: "Cria um componente que recebe um comentário (que pode conter HTML malicioso como <script>alert('hack')</script>) e usa o DOMPurify para garantir que apenas texto seguro é renderizado.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Nunca concatenes strings traduzidas! Usa placeholders (ex: 'Olá {{nome}}') para manter a ordem correta das palavras em cada língua. A gramática muda, o teu código não deve quebrar.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo como formatar uma data para o padrão europeu.`,
    practice: "Cria uma interface simples com um título e um parágrafo. Implementa suporte para Português e Inglês, permitindo que o utilizador alterne entre eles através de botões com bandeiras.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Se o teu site não funciona apenas com o teclado (sem rato), ele não é acessível. Testa sempre a navegação com o TAB!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Consigo navegar na minha app usando apenas o teclado.`,
    practice: "Faz uma auditoria de acessibilidade no teu projeto atual usando o Lighthouse. Corrige pelo menos 3 problemas encontrados (ex: contraste de cor, falta de alt text, ou estrutura de títulos).",
    resources: [
  ...
  },
  {
    ...
    proTip: "Menos é mais. Animações devem guiar o utilizador e dar feedback, não distraí-lo ou tornar a app lenta. Usa movimentos suaves e intencionais!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo a importância de animar apenas o necessário para performance.`,
    practice: "Cria um Modal (janela flutuante) que surge com um efeito de 'zoom' vindo do centro e desaparece suavemente quando o utilizador clica em 'Fechar'.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Usa atributos 'data-cy' ou 'data-testid' para os teus seletores. As classes CSS mudam frequentemente para design e podem quebrar os teus testes sem necessidade. Mantém os teus testes resilientes!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Percebo a importância dos testes de integração completa.`,
    practice: "Cria um teste Cypress que: 1. Visita a página inicial, 2. Clica numa aula, 3. Verifica se o título da aula está correto no ecrã.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Configura um 'Health Check'. Se a nova versão da app falhar no arranque, o teu pipeline deve fazer 'Rollback' automático para a versão anterior. Segurança acima de tudo!",
    content: `### O que vais aprender nesta aula:
...
- [ ] Sei onde guardar chaves secretas de forma segura.`,
    practice: "Faz o deploy do teu projeto do curso para a Vercel. Configura uma variável de ambiente no painel da Vercel e verifica se o teu site a consegue ler.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Pergunta-te: 'Se eu tiver que remover esta funcionalidade, quantos ficheiros tenho que tocar?'. Quanto menos ficheiros, melhor é a tua arquitetura e mais isolado está o teu código.",
    content: `### O que vais aprender nesta aula:
...
- [ ] Estou pronto para o meu Projeto Final Profissional.`,
    practice: "Reorganiza a estrutura de pastas do teu projeto atual. Cria uma pasta 'services' para as tuas chamadas de API e uma pasta 'components' para elementos reutilizáveis.",
    resources: [
  ...
  },
  {
    ...
    proTip: "Qualidade sobre Quantidade. Um projeto final perfeito, com testes, acessibilidade e boa arquitetura vale mais do que 10 projetos incompletos no teu portefólio. Brilha nos detalhes!",
...
- [ ] Tornei-me um developer completo, pronto para o mercado.`,
    practice: "Finaliza o teu projeto, faz o Push para o GitHub, garante que o Deploy na Vercel está ativo e partilha o link do teu certificado no LinkedIn! Tu conseguiste! 🏆",
    resources: [
